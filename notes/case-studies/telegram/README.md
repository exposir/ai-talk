...
**核心开发者**：**John Preston**
([@john_preston](https://github.com/john-preston))
...
**核心开发者**：**Mikhail Filimonov** ([@overtake](https://github.com/overtake))
...
**Web K 开发者**：**Igor Zhukov** ([@Kigurumi](https://github.com/zhukov))
...
**Web A 开发者**：**Antony** ([@Ajaxy](https://github.com/Ajaxy))

| 项目     | 信息                         |
| -------- | ---------------------------- |
| **身份** | JavaScript 竞赛获胜者        |
| **特点** | 界面更现代，功能迭代激进     |
| **技术** | TypeScript + React，PWA 架构 |
...
**核心开发者**：**DrKLO** ([@DrKLO](https://github.com/DrKLO))
