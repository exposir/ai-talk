...
- **社交媒体**：
  - 🐦 Twitter/X:
    [@Kolja_Durov](https://twitter.com/Kolja_Durov)（保持低调，较少活跃）
...
| **项目仓库** | [tdesktop](https://github.com/telegramdesktop/tdesktop) |
...
| **项目仓库** | [TelegramSwift](https://github.com/overtake/TelegramSwift) |
...
| **项目仓库** | [Webogram](https://github.com/zhukov/webogram)<br>[Telegram-web-k](https://github.com/TelegramOrg/Telegram-web-k) |
...
| **特点**     | 界面更现代，功能迭代激进                            |
| **技术**     | TypeScript + 自研 Teact 框架（React 范式）          |
| **GitHub**   | [@Ajaxy](https://github.com/Ajaxy)                  |
| **项目仓库** | [telegram-tt](https://github.com/Ajaxy/telegram-tt) |
| **官方地址** | [web.telegram.org/a](https://web.telegram.org/a)    |
...
| **项目仓库** | [Telegram-iOS](https://github.com/TelegramMessenger/Telegram-iOS) |
...
| **项目仓库** | [Telegram](https://github.com/DrKLO/Telegram) (27.9k ⭐) |
...
- [Telegram Desktop GitHub](https://github.com/telegramdesktop/tdesktop) - 查看 John
  Preston 的提交历史
...
- **TelegramMessenger**:
  [github.com/telegrammessenger](https://github.com/telegrammessenger)
  - 16 个仓库，包括 iOS 客户端、Mini Apps SDK 等
- **TelegramOrg**: [github.com/TelegramOrg](https://github.com/TelegramOrg)
  - 统一的官方客户端组织
- **telegramdesktop**:
  [github.com/telegramdesktop](https://github.com/telegramdesktop)
  - Desktop 版本专用组织
