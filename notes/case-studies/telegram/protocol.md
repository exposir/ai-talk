...
| 应用         | 加密协议         | 默认 E2E          | 开源        | 量子安全 | 特点                   |
| ------------ | ---------------- | ----------------- | ----------- | -------- | ---------------------- |
| **Telegram** | MTProto 2.0      | ❌ 仅 Secret Chat | 规范公开    | ❌       | 移动优化，自研         |
| **WhatsApp** | Signal Protocol  | ✅                | ❌ 闭源实现 | ❌       | 业界标准，Meta 旗下    |
| **Signal**   | Signal Protocol  | ✅                | ✅ 完全开源 | ✅ PQXDH | 隐私标杆，非营利       |
| **iMessage** | PQ3              | ✅ 仅 Apple 设备  | ❌          | ✅ Kyber | 量子安全等级最高       |
| **微信**     | MMTLS (魔改 TLS) | ❌                | ❌          | ❌       | 服务器可读，无前向保密 |
| **Line**     | Letter Sealing   | ✅ 可选           | ❌          | ❌       | 日本/东南亚流行        |
| **Discord**  | TLS 1.3          | ❌                | ❌          | ❌       | 仅传输加密，服务器可读 |
