...
| 产品    | 2025.Q1     | 2025.Q2 | 2025.Q3 | 2025.Q4  | 增长率  |
| ------- | ----------- | ------- | ------- | -------- | ------- |
| ChatGPT | 4 亿 (周活) | 5 亿    | 7 亿    | 8.1 亿   | +102%   |
| Gemini  | 3.5 亿      | 4.5 亿  | 4.5 亿  | 5-6.5 亿 | +50-85% |
| Claude  | 1890 万     | 3000 万 | 5000 万 | 5000 万+ | +165%   |
| Grok    | 1760 万     | 3000 万 | 3500 万 | 6400 万  | +264%   |

#### 国内市场月活用户对比（2025 年）

| 产品     | 2025.Q1 | 2025.Q2 | 2025.Q3 | 2025.Q4    | 增长率 |
| -------- | ------- | ------- | ------- | ---------- | ------ |
| 豆包     | 1.2 亿  | 1.41 亿 | 1.59 亿 | 1.55 亿    | +29%   |
| DeepSeek | 3370 万 | 1.7 亿  | 1.46 亿 | 1.45 亿    | +330%  |
| 千问     | 400 万  | 500 万  | -       | 3000 万+   | +650%  |
| Kimi     | 1400 万 | 1400 万 | 990 万  | 450 万(周) | -68%   |
| 文心一言 | 1100 万 | 1100 万 | 530 万  | -          | -52%   |

#### 增长趋势图

```mermaid
xychart-beta
    title "国际 AI 产品月活用户趋势 (2025年, 单位: 亿)"
    x-axis ["Q1", "Q2", "Q3", "Q4"]
    y-axis "MAU (亿)" 0 --> 10
    line "ChatGPT" [4, 5, 7, 8.1]
    line "Gemini" [3.5, 4.5, 4.5, 5.5]
    line "Claude" [0.19, 0.3, 0.5, 0.5]
    line "Grok" [0.18, 0.3, 0.35, 0.64]
```

```mermaid
xychart-beta
    title "国内 AI 产品月活用户趋势 (2025年, 单位: 亿)"
    x-axis ["Q1", "Q2", "Q3", "Q4"]
    y-axis "MAU (亿)" 0 --> 2
    line "豆包" [1.2, 1.41, 1.59, 1.55]
    line "DeepSeek" [0.34, 1.7, 1.46, 1.45]
    line "千问" [0.04, 0.05, 0.1, 0.3]
    line "Kimi" [0.14, 0.14, 0.1, 0.05]
```
